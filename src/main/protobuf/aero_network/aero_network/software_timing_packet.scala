...
@SerialVersionUID(0L)
final case class software_timing_packet(
    ...
    ) extends com.trueaccord.scalapb.GeneratedMessage with com.trueaccord.scalapb.Message[software_timing_packet] with com.trueaccord.lenses.Updatable[software_timing_packet] {
    @transient
    ...
    def mergeFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): aero_network.aero_network.software_timing_packet = {
      ...
      aero_network.aero_network.software_timing_packet(
    ...
    def clearTimeBucket: software_timing_packet = copy(timeBucket = None)
    def withTimeBucket(__v: Long): software_timing_packet = copy(timeBucket = Some(__v))
    def getExperimentId: String = experimentId.getOrElse("")
    def clearExperimentId: software_timing_packet = copy(experimentId = None)
    def withExperimentId(__v: String): software_timing_packet = copy(experimentId = Some(__v))
    def getClientId: String = clientId.getOrElse("")
    def clearClientId: software_timing_packet = copy(clientId = None)
    def withClientId(__v: String): software_timing_packet = copy(clientId = Some(__v))
    def getPacketId: Long = packetId.getOrElse(0L)
    def clearPacketId: software_timing_packet = copy(packetId = None)
    def withPacketId(__v: Long): software_timing_packet = copy(packetId = Some(__v))
    def getTimeSent: Long = timeSent.getOrElse(0L)
    def clearTimeSent: software_timing_packet = copy(timeSent = None)
    def withTimeSent(__v: Long): software_timing_packet = copy(timeSent = Some(__v))
    def getResponseTime: Long = responseTime.getOrElse(0L)
    def clearResponseTime: software_timing_packet = copy(responseTime = None)
    def withResponseTime(__v: Long): software_timing_packet = copy(responseTime = Some(__v))
    ...
    def companion = aero_network.aero_network.software_timing_packet
}

object software_timing_packet extends com.trueaccord.scalapb.GeneratedMessageCompanion[aero_network.aero_network.software_timing_packet] {
  implicit def messageCompanion: com.trueaccord.scalapb.GeneratedMessageCompanion[aero_network.aero_network.software_timing_packet] = this
  def fromFieldsMap(__fieldsMap: scala.collection.immutable.Map[_root_.com.google.protobuf.Descriptors.FieldDescriptor, scala.Any]): aero_network.aero_network.software_timing_packet = {
  ...
  lazy val defaultInstance = aero_network.aero_network.software_timing_packet(
  )
  implicit class software_timing_packetLens[UpperPB](_l: _root_.com.trueaccord.lenses.Lens[UpperPB, aero_network.aero_network.software_timing_packet]) extends _root_.com.trueaccord.lenses.ObjectLens[UpperPB, aero_network.aero_network.software_timing_packet](_l) {
